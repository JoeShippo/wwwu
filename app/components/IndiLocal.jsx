...
export default function IndiLocal() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-black/80 md:bg-black/40" /> {/* overlay */}
      <div className="relative z-10 w-full max-w-[90vw] mx-auto py-20 md:py-30 2xl:py-50">
        ...
        <p className="text-lg sm:text-lg md:text-xl 2xl:text-2xl leading-relaxed mb-10 text-white md:w-2/3">
